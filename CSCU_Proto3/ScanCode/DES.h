...
/*! /Brief CDES类说明
 *
 * 该类是DES和3DES<a href="http://lib.csdn.net/base/datastructure" class='replace_word' title="算法与数据结构知识库" target='_blank' style='color:#df3434; font-weight:bold;'>算法</a>类
 */
class cDES  :public QObject
{
    Q_OBJECT
public:
    cDES();
