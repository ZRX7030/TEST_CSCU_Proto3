#ifndef IEC104SERVER_H
#define IEC104SERVER_H

#include <QTcpSocket>
#include "IEC104Define.h"
#include "DevCache.h"
...
class CIEC104Server : public CModuleIO
{
    Q_OBJECT
public:
    CIEC104Server();
...
private:
	...
	void ParseCommAddr(InfoMap &mapInfo);//解析通信地址
	...
	stServer0Config m_confServer;//服务器配置
