...
#define STATION_NO_LEN 16
#define BCD_STATION_NO_LEN 8

//#define FUN_SCREEN_DISCHARGE                 //放电功能
//#define FUN_SCREEN_CTRL_CARLOCK           //串口控制车位锁功能
...
//函数功能:将10进制 unsigned char数组转换成qstring XX
QString CoventUnsignedCharToQString(unsigned char * p,unsigned char p_length);

bool ConvertQstr2Hex(QString src_str, unsigned char *dst_data, int max_data);//将QString变量转换成16进制数组  add by YCZ 2016-03-18
...
//system函数,linux命令执行结果,返回值,输入 ret_in =  system(...)

bool SystemFuncResult(int ret_in);

void QDateTime2CharArray(QDateTime &dtQDateTime, char * dst);//QDateTime转["2016-11-18 10:40:41"]
void CharArray2QDateTime(char * src, QDateTime &dtQDateTime);//["2016-11-18 10:40:41"]转QDateTime
//检查终端类型
